...
#
tab11 <- read_excel(
  "data/variables/2010/tab11.xlsx",
  range = "A4249:C4542",
...
#
tab12 <- tab12 <- read_excel(
  "data/variables/2010/tab12.xlsx",
  col_names = FALSE,
  col_types = c("numeric",
                "text", "text", "numeric")
) %>%
...
#
tab13 <- read_excel(
  "data/variables/2010/tab13.xlsx",
  col_names = FALSE,
  col_types = c("numeric",
                "text", "text", "numeric")
) %>%
...
#
tab14 <- read_excel(
  "data/variables/2010/tab14.xlsx",
  col_names = FALSE,
  col_types = c("numeric",
                "text", "text", "numeric")
) %>%
...
data <-
  inner_join(x1, x2, suffix = c("code_muni", "territorialidades")) %>%
