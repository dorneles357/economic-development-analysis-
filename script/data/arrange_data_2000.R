...
x3_x4_x7 <- read_excel(
  "data/variables/2000/x3-x4-x7.xlsx",
  col_types = c("text", "text", "numeric",
                "numeric", "numeric")
) %>%
  rename(
    territorialidades = territorialidades...2,
...
x12_x13_x14 <- read_excel(
  "data/variables/2000/x12-x13-x14.xlsx",
  col_names = FALSE,
  col_types = c("text",
...
x15_x8_x9 <- read_excel(
  "data/variables/2000/x15-x8-x9.xlsx",
  col_names = FALSE,
  col_types = c("text", "text", "numeric",
                "numeric", "numeric")
) %>%
...
data <-
  inner_join(x2, x3, suffix = c("code_muni", "territorialidades")) %>%
